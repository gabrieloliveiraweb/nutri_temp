...
export default function App() {
  return (
    <div className="min-h-screen selection:bg-[#E8A598]/30">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <Reveal>
            <div className="space-y-8 max-w-xl">
              <h1 className="serif text-5xl md:text-6xl lg:text-7xl text-[#3A3532] leading-[1.1] mb-6 font-semibold">
                Emagreça até 5kg em apenas 3 semanas com um método rápido, comprovado e consistente!
              </h1>
              <p className="text-[#4A4440] text-lg opacity-70 leading-relaxed font-normal">
                {CONTENT.hero.subtitle}
              </p>
              <Button className="group !rounded-lg !py-6 !px-10 !bg-[#4A5D45] text-sm">
                QUERO COMEÇAR AGORA
          ...
          <Reveal delay={0.2}>
            <div className="relative flex justify-center lg:justify-end">
              <div 
                className="relative w-full max-w-[500px] aspect-[4/5] bg-gray-100 rounded-t-[250px] rounded-b-[50px] overflow-hidden border-[15px] border-white shadow-2xl"
              >
                <img 
        ...
        <div className="flex whitespace-nowrap animate-marquee">
          {[...Array(20)].map((_, i) => (
            <div key={i} className="flex items-center gap-6 px-12">
              ...
              <span className="text-[10px] uppercase font-bold tracking-[0.4em] text-white">EASY</span>
              <span className="text-[10px] uppercase font-bold tracking-[0.4em] text-white/50">BUILDER</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <section id="beneficios" className="py-32 px-6 md:px-12 w-full bg-white border-b border-[#F0EBE5]">
      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
        <Reveal>
          <div className="text-center mb-16 space-y-4">
             <span className="text-[9px] uppercase tracking-[0.3em] font-bold text-[#E8A598]">SERVIÇOS</span>
             <h2 className="serif text-4xl md:text-5xl text-[#3A3532] leading-tight font-semibold">Como posso te ajudar <br/> a atingir seus objetivos</h2>
          </div>
        </Reveal>
      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
        <Reveal>
            <div className="bg-[#4A5D45] rounded-[48px] p-16 md:p-24 text-center space-y-10 shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 right-0 w-80 h-80 bg-white/5 rounded-full blur-[100px] -mr-40 -mt-40" />
                <h2 className="serif text-4xl md:text-6xl text-white font-semibold leading-tight">
                   A sua transformação <br className="hidden md:block" /> começa com uma decisão.
                </h2>
                <p className="text-white/60 text-lg max-w-xl mx-auto font-light">Não espere a "segunda-feiira" para priorizar a sua saúde e bem-estar.</p>
                <Button variant="white" className="mx-auto !rounded-lg !py-5 !px-12 group !text-[#4A5D45] !shadow-2xl">
      ...
      <section className="py-32 overflow-hidden bg-white border-y border-[#F0EBE5]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 mb-20">
            <Reveal>
                <span className="text-[9px] uppercase tracking-[0.3em] font-bold text-[#4A5D45]">DEPOIMENTOS</span>
                <h2 className="serif text-4xl md:text-6xl text-[#3A3532] mt-4 font-semibold">Histórias de quem <br/> transformou sua vida</h2>
                <Button variant="secondary" className="mt-10 !px-12 !py-5 !rounded-lg group">
                    QUERO COMEÇAR AGORA
                    <div className="bg-white/20 p-1 rounded-full text-white ml-3">
                        <ArrowRight className="w-4 h-4 rotate-[-45deg]" />
                    </div>
      ...
      <section id="metodo" className="py-32 px-6 md:px-12 bg-white">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 items-stretch">
              <div className="grid grid-cols-2 grid-rows-2 gap-4">
                  {CONTENT.metodo.steps.map((step, idx) => (
                      <Reveal key={idx} delay={idx * 0.1}>
                          <div className={`p-12 h-full rounded-[32px] flex flex-col justify-between transition-transform duration-500 hover:scale-[1.02] ${idx === 0 || idx === 3 ? 'bg-[#FAF7F2] text-[#3A3532]' : 'bg-[#4A5D45] text-white'}`}>
                              <span className="serif text-7xl font-bold opacity-20">{step.number}</span>
                              <div className="mt-8">
                                  <h3 className="serif text-2xl font-bold mb-4">{step.title}</h3>
                                  <p className="text-xs leading-relaxed opacity-70 font-medium">{step.description}</p>
                              </div>
                          </div>
                      </Reveal>
                  ))}
              ...
              <Reveal delay={0.4}>
                  <div className="h-full rounded-[48px] overflow-hidden shadow-2xl relative group">
                     <img 
      ...
      {/* Sobre Section */}
      <section id="sobre" className="py-32 px-6 md:px-12 max-w-7xl mx-auto border-t border-[#F0EBE5]">
        <div className="grid md:grid-cols-2 gap-24 items-stretch">
          <Reveal>
             <div className="space-y-10 h-full flex flex-col justify-center">
                  <div className="space-y-4">
                    ...
                    <h2 className="serif text-5xl md:text-[64px] font-semibold text-[#3A3532] leading-tight">Quem vai te ajudar <br/> nessa jornada?</h2>
                  </div>
                  <p className="text-[#4A4440] text-lg leading-relaxed opacity-70 font-light italic border-l-4 border-[#E8A598] pl-8 py-2">
                  ...
                  <Button variant="secondary" className="!px-12 !py-5 !rounded-lg group">
                      CONHECER MEU MÉTODO
                      <div className="bg-white/20 p-1 rounded-full text-white ml-3">
                        <ArrowRight className="w-4 h-4 rotate-[-45deg]" />
                      </div>
          ...
          <Reveal delay={0.2}>
            <div className="rounded-[60px] overflow-hidden shadow-2xl border-[12px] border-[#FAF7F2] h-full">
      ...
      {/* Footer */}
      <footer className="bg-[#3D4D38] text-white pt-32 pb-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-28">
             <div className="space-y-8">
                ...
                <p className="text-white/40 text-xs leading-relaxed max-w-xs uppercase tracking-widest font-bold">Nutrição humanizada para mulheres modernas que buscam autonomia e saúde sustentável.</p>
                <div className="flex gap-5">
                   {CONTENT.footer.socials.map((s, i) => {
                       const Icon = IconMap[s.icon];
                       return (
                           <a key={i} href="#" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#E8A598] hover:text-white transition-all transform hover:scale-110">
             ...
             <div>
                <h4 className="text-[11px] uppercase font-bold tracking-[0.25em] mb-12 text-[#E8A598]">Endereço</h4>
                <p className="text-white/50 text-xs leading-relaxed font-medium">Av. das Araucárias, 1200 — Cj 402<br/>Bairro Lago Azul, São Paulo - SP</p>
                <h4 className="text-[11px] uppercase font-bold tracking-[0.25em] mt-12 mb-6 text-[#E8A598]">Contato</h4>
                <ul className="space-y-3 text-white/50 text-xs font-bold">
                    <li>+55 (11) 99999-9999</li>
                    <li>contato@easybuilder.nutri</li>
                </ul>
             </div>
             <div>
                <h4 className="text-[11px] uppercase font-bold tracking-[0.25em] mb-12 text-[#E8A598]">Explorar</h4>
                <ul className="space-y-5 text-white/50 text-xs font-bold">
             ...
             <div>
                <h4 className="text-[11px] uppercase font-bold tracking-[0.25em] mb-12 text-[#E8A598]">Recursos</h4>
                <ul className="space-y-5 text-white/50 text-xs font-bold">
          ...
          <div className="pt-16 border-t border-white/5 text-[10px] uppercase font-bold tracking-[0.4em] text-white/20 flex flex-col md:flex-row justify-between items-center gap-6">
